...
resource "aws_security_group" "qdrant_prod" {
  description = "Security group for prod Qdrant EC2 (private subnet)"
  ...
  ingress {
    ...
    to_port         = 6333
    protocol        = "tcp"
    description     = "Qdrant HTTP from app SG"
  }
  ...
  ingress {
    ...
    to_port         = 6334
    protocol        = "tcp"
    description     = "Qdrant gRPC from app SG"
  }
  ...
  ingress {
    ...
    to_port         = 6333
    protocol        = "tcp"
    description     = "Qdrant HTTP from prod k8s worker SG (FastAPI)"
  }
  ...
  ingress {
    ...
    to_port         = 6334
    protocol        = "tcp"
    description     = "Qdrant gRPC from prod k8s worker SG (FastAPI)"
  }
